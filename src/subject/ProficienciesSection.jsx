...
function StrTok() {
    return (
        <section className="w-full py-4">
            ...
            <Toggle title="LCS" color={"proficiencies"}>
                <P>The strtok function is used to tokenize (split) a string into smaller parts (tokens) based on a specified delimiter...</P>
                <PrototypeMessage>
